...
CGO_ENABLED=1 GOOS=darwin GOARCH=amd64 go build -o build/${PROGRAM_NAME}_mac_intel main.go

# Mac M1
GOOS=darwin GOARCH=arm64 go build -o build/${PROGRAM_NAME}_mac_m1 main.go
